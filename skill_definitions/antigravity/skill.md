...
Set the `SME_FOLDER` variable to the path of the shared folder:

```
SME_FOLDER=G:/My Drive/offboarding/jane-doe
```

Then reference files as `${SME_FOLDER}/.sme-clone/_INDEX.md`, etc.
